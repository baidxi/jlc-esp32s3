...
struct sysfs_bus_node {
    ...
    struct list_head devices;       /* 总线下的设备节点链表 */
};
...
struct sysfs_root {
    ...
    struct list_head buses;         /* 总线节点链表 */
    struct list_head devices;       /* 设备节点链表 */
};
